...
return [
    ...
    'api_post_voir' => [['offset'], ['offset' => 0, '_controller' => 'App\\Controller\\HomeController::voirPlus'], [], [['variable', '/', '[^/]++', 'offset', true], ['text', '/api']], [], [], []],
    'home_faq' => [[], ['_controller' => 'App\\Controller\\HomeController::faq'], [], [['text', '/faq']], [], [], []],
    'bdd' => [[], ['_controller' => 'App\\Controller\\HomeController::bdd'], [], [['text', '/bdd']], [], [], []],
    ...
    'post-detail' => [['id'], ['_controller' => 'App\\Controller\\PostController::detail'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/post']], [], [], []],
    'category-posts' => [['name'], ['_controller' => 'App\\Controller\\PostController::categoryPosts'], [], [['variable', '/', '[^/]++', 'name', true], ['text', '/category']], [], [], []],
    'editor-posts' => [['id'], ['id' => null, '_controller' => 'App\\Controller\\PostController::editorPosts'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/editor']], [], [], []],
    'date-posts' => [['date'], ['_controller' => 'App\\Controller\\PostController::datePosts'], [], [['variable', '/', '[^/]++', 'date', true], ['text', '/date']], [], [], []],
    'search' => [[], ['_controller' => 'App\\Controller\\PostController::search'], [], [['text', '/search']], [], [], []],
