...
class Entreprise extends \App\Entity\Entreprise implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'pays', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'contact', '' . "\0" . 'App\\Entity\\Entreprise' . "\0" . 'users'];
        }
     ...
     * {@inheritDoc}
     */
    public function setContact(string $contact): \App\Entity\Entreprise
    {
